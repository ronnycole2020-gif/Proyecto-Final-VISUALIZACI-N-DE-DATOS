...
- Consumir APIs reales de NOAA, NASA GPM, INOCAR, CELEC e INAMHI.
- Procesar cada fuente en un job independiente y consolidar resultados por ventanas temporales.
- Incorporar un DEM SRTM o Copernicus.
- Calcular rutas reales con OSRM, GraphHopper o pgRouting.
- Desplegar la API y el dashboard en infraestructura cloud.
- Incorporar autenticación, monitoreo y tolerancia a fallos.
